  const content = {
    en: `
     ...
     I have over <mark>10 years</mark> of experience conducting both qualitative and quantitative research
            across academic and industry settings. My doctoral research investigated <mark>social closure categories</mark>, such as race, ethnicity and nation: how individuals socially construct them, what consequences these have for inequality, and how we can <mark>design better policies</mark> to alleviate these. I use a variety of methods with a focus on <mark>computational social science, statistics, and causal inference</mark>. My dissertation work involved designing, implementing, and analyzing an original survey and experiment distributed across 5 countries. I currently work as Postdoctoral Research Scientist applying computational methods and advanced causal inference approaches to understand how policy and institutional environments shape <mark>substance use and public health outcomes</mark>, as well as studying how  <mark>AI is being implemented in healthcare settings </mark>, with a particular focus on the  <mark>human, social, and ethical dimensions  </mark>of the design, use, and understanding of these tools. 
